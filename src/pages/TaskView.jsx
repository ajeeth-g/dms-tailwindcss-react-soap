...
const TaskView = () => {
  ...
  const filteredTasks = useMemo(() => {
    return taskData.filter((task) => {
      ...
      if (statusFilter !== "all") {
        // Map filter value to task status if necessary
        // For example, you might treat "approved" as "ACCEPTED" and "pending" as "NEW"
        const statusMapping = {
          approved: "ACCEPTED",
          pending: "NEW",
        };
        statusMatch = task.STATUS === (statusMapping[statusFilter] || statusFilter);
      }
